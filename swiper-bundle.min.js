                ...
                C(e, {
                    resize: {
                        ...
                        removeObserver: function () {
                            e.resize.observer && e.resize.observer.unobserve && e.el && (
                    ...
                    if (!(!s.isTouchEvent && "button" in d && d.button > 0)) 
                        if (!s.isTouched || !s.isMoved) 
                            if (
                                ...
                                l.currentX = "touchstart" === d.type
                                    ? d
                                        .targetTouches[0]
                                        .pageX
                                    : d.pageX,
                                l.currentY = "touchstart" === d.type
                                    ? d
                                        .targetTouches[0]
                                        .pageY
                                    : d.pageY;
    ...
    function D(e) {
        ...
        if (l.originalEvent && (l = l.originalEvent), i.isTouched) {
            if (!i.isTouchEvent || "touchmove" === l.type) {
                var d = "touchmove" === l.type && l.targetTouches && (
    ...
    function N(e) {
        ...
        if (
            ...
            if (i.freeMode) {
                ...
                if (i.freeModeMomentum) {
                    ...
                    if (w < t.maxTranslate()) 
                        ...
                        w = -(
                            w = Math.abs(l[M] - w) < Math.abs(l[M - 1] - w) || "next" === t.swipeDirection
                                ? l[M]
                                : l[M - 1]
                        )
                    }
            ...
            for (
                var L = 0,
                $ = t.slidesSizesGrid[0],
                I = 0; I < o.length; I += I < i.slidesPerGroupSkip
                    ? 1
                    : i.slidesPerGroup
            ) {
        ...
        V = {
            ...
            update: {
                ...
                updateSlides: function () {
                    ...
                    if (void 0 !== r) {
                        ...
                        i.slidesPerColumn > 1 && (
                            T = Math.floor(c / i.slidesPerColumn) === c / e.params.slidesPerColumn
                                ? c
                                : Math.ceil(c / i.slidesPerColumn) * i.slidesPerColumn,
                            "auto" !== i.slidesPerView && "row" === i.slidesPerColumnFill && (
                        ...
                        for (
                            ...
                            if (i.slidesPerColumn > 1) {
                                ...
                                if ("row" === i.slidesPerColumnFill && i.slidesPerGroup > 1) {
                                    ...
                                    O.css(
                                        {"-webkit-box-ordinal-group": A, "-moz-box-ordinal-group": A, "-ms-flex-order": A, "-webkit-order": A, order: A}
                                    )
                                } else 
                        ...
                        if (!i.centeredSlides) {
                            ...
                            u = M,
                            Math.floor(e.virtualSize - r) - Math.floor(u[u.length - 1]) > 1 && u.push(
                                e.virtualSize - r
                            )
                        }
            ...
            slide: {
                slideTo: function (e, t, a, i) {
                    ...
                    (c || o.initialSlide || 0) === (p || 0) && a && r.emit(
            ...
            events: {
                attachEvents: function () {
                    ...
                    if (!l.touch && l.pointerEvents) 
                        ...
                        if (l.touch) {
                            var p = !(
                                "touchstart" !== i.start || !l.passiveListener || !a.passiveListeners
                            ) && {
                                passive: !0,
                                capture: !1
                            };
                ...
                detachEvents: function () {
                    ...
                    if (!l.touch && l.pointerEvents) 
                        ...
                        if (l.touch) {
                            var p = !(
                                "onTouchStart" !== i.start || !l.passiveListener || !a.passiveListeners
                            ) && {
                                passive: !0,
                                capture: !1
                            };
                    ...
                    t.isHorizontal()
                        ...
                        : ((p || c || v || f) && (
                            n.preventDefault
                                ? n.preventDefault()
                                : n.returnValue = !1
                        ), (c || f) && t.slideNext(), (p || v) && t.slidePrev()),
                    t.emit("keyPress", l)
                }
            },
            enable: function () {
    ...
    var K = {
            ...
            handle: function (e) {
                ...
                if (
                    ...
                    if (
                        T.push(y),
                        S
                            ? (y.direction !== S.direction || y.delta > S.delta || y.time > S.time + 150) && a.mousewheel.animateSlider(
                                y
                            )
            ...
            update: function () {
                ...
                if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                    ...
                    if (
                        ...
                        if (a.dynamicBullets && (e.pagination.bulletSize = p.eq(0)[
                        ...
                        ), o = i - e.pagination.dynamicBulletIndex, d = (
                            ...
                            p.each((function (e) {
                                ...
                                a.dynamicBullets && (s >= o && s <= l && t.addClass(
                                    a.bulletActiveClass + "-main"
                                ), s === o && t.prev().addClass(a.bulletActiveClass + "-prev").prev().addClass(
                                    a.bulletActiveClass + "-prev-prev"
                                ), s === l && t.next().addClass(a.bulletActiveClass + "-next").next().addClass(
                    ...
                    if (
                        "fraction" === a.type && (r.find(z(a.currentClass)).text(a.formatFractionCurrent(
                            i + 1
        ...
        se = {
            ...
            init: function () {
                ...
                e
                    .a11y
                    .addElRole(m(e.slides), t.slideRole),
                e
                    .slides
                    .each((function (a) {
                        var i = m(a),
                ...
                e.pagination && e.params.pagination.clickable && e.pagination.bullets && e.pagination.bullets.length && e
                    .pagination
                    .$el
                    .on("keydown", z(e.params.pagination.bulletClass), e.a11y.onEnterOrSpaceKey)
            },
            destroy: function () {
                var e,
                    t,
                ...
                a.pagination && a.params.pagination.clickable && a.pagination.bullets && a.pagination.bullets.length && a
                    .pagination
                    .$el
                    .off("keydown", z(a.params.pagination.bulletClass), a.a11y.onEnterOrSpaceKey)
            }
        },
        re = {
            init: function () {
            ...
            setTranslate: function () {
                ...
                for (var v = 0; v < s.length; v += 1) {
                    ...
                    if (
                        ...
                        0 === C.length && (C = m('<div class="swiper-slide-shadow-' + (
                            c
                                ? "left"
                                : "top"
                        ) + '"></div>'), f.append(C)),
        ...
        ce = {
            setTranslate: function () {
                for (
                    ...
                    Math.abs(b) < .001 && (b = 0),
                    Math.abs(T) < .001 && (T = 0);
                    var S = "translate3d(" + x + "px," + E + "px," + w + "px)  rotateX(" + b + "deg" +
        ...
        ue = {
            init: function () {
                ...
                return t.swiper instanceof a
                    ? (e.thumbs.swiper = t.swiper, C(e.thumbs.swiper.originalParams, {
                        watchSlidesProgress: !0,
                        slideToClickedSlide: !1
                ...
                if (a) {
                    ...
                    if (t.realIndex !== a.realIndex || r) {
                        ...
                        if (a.params.loop) {
                            ...
                            o = (n = t.realIndex) > t.previousIndex
                                ? "next"
                                : "prev";
                        r && (
                            n += "next" === o
                    ...
                    click: function (e, t) {
                        ...
                        if (e.params.pagination.el && e.params.pagination.hideOnClick && e.pagination.$el.length > 0 && !m(a).hasClass(e.params.pagination.bulletClass)) {
                            ...
                            !0 === e
                                .pagination
                                .$el
                                .hasClass(e.params.pagination.hiddenClass)
